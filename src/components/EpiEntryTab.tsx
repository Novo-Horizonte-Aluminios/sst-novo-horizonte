  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-sm font-black tracking-tight text-slate-800 uppercase">Entrada de EPI's</h3>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
          <table className="compact-table">
            ...
            <tbody>
              {entries.map(entry => (
                <tr key={entry.id}>
                  <td className="font-bold text-slate-800">{entry.ppeName}</td>
                  <td>
                  ...
                  <td className="font-mono text-[11px] text-slate-500">{entry.invoiceNumber || 'N/A'}</td>
                  <td>
          ...
          <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden animate-fade-in text-xs border border-slate-100">
            ...
            <form onSubmit={handleCreateEntry} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="font-semibold block mb-1 text-slate-600">Data da Entrada</label>
                  <input
                    type="date"
                    required
              ...
              <div>
                <label className="font-semibold block mb-1 text-slate-600">Fornecedor / Distribuidor</label>
                <input
                  type="text"
              ...
              <div>
                <label className="font-semibold block mb-1 text-slate-600">Número da Nota Fiscal (NF)</label>
                <input
                  type="text"
