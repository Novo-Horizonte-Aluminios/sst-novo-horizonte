...
export default function IncidentTab({
  ...
  return (
    <div className="space-y-4 text-xs">
      ...
      {/* Tab Header layout */}
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center bg-white dark:bg-slate-800 p-4 rounded border border-slate-200 dark:border-slate-700 shadow-sm">
        <div>
                ...
                <div
                  ...
                  className={`p-3 rounded border transition cursor-pointer text-left flex flex-col justify-between ${
                    isActive 
                      ...
                      : 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700/50 dark:bg-slate-900 text-slate-600 dark:text-slate-300'
                  }`}
                >
                  ...
                  <h3 className="font-bold text-slate-800 dark:text-slate-100 text-[11px] line-clamp-1 mt-1 leading-snug">{acc.description}</h3>
        ...
        <div className="lg:col-span-2 space-y-4">
          {selectedAccident ? (
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-slate-800 p-4 rounded border border-slate-200 dark:border-slate-700 shadow-sm space-y-3">
                <div className="flex justify-between items-center pb-1.5 border-b border-slate-100 dark:border-slate-700">
                  <h3 className="font-bold text-slate-700 dark:text-slate-200 uppercase tracking-tight text-[10px] flex items-center gap-1">
                ...
                <p className="bg-slate-50 dark:bg-slate-900 p-2.5 rounded border border-slate-250 italic text-[10.5px] leading-relaxed text-slate-600 dark:text-slate-300">
                  &ldquo;{selectedAccident.description}&rdquo; — <strong className="font-sans text-slate-700 dark:text-slate-200 not-italic text-[9px] uppercase font-bold text-safety-green">Registrado por: {selectedAccident.reporterName}</strong>
                </p>
              ...
              <div className="bg-white dark:bg-slate-800 p-4 rounded border border-slate-200 dark:border-slate-700 shadow-sm space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                  ...
                  <div className="p-2.5 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded space-y-0.5">
              ...
              <div className="bg-white dark:bg-slate-800 p-4 rounded border border-slate-200 dark:border-slate-700 shadow-sm space-y-4">
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="font-bold text-slate-800 dark:text-slate-100 uppercase tracking-tight text-[11px] flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-1 text-[9px] bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-2 py-0.5 rounded font-mono text-slate-500 dark:text-slate-400 font-bold">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                  {[
                    { id: 'Pendente', title: 'Planejamento (Plan)', color: 'border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-slate-900/40', badgeColor: 'bg-sky-100 text-sky-850', hoverBorder: 'border-sky-400 bg-sky-50/20', icon: '📋', desc: 'Identificar e analisar desvios' },
                    { id: 'Em Andamento', title: 'Execução (Do)', color: 'border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-slate-900/40', badgeColor: 'bg-amber-100 text-amber-850', hoverBorder: 'border-amber-400 bg-amber-50/20', icon: '⚙️', desc: 'Implementar as medidas' },
                    { id: 'Verificando', title: 'Verificação (Check)', color: 'border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-slate-900/40', badgeColor: 'bg-indigo-100 text-indigo-855', hoverBorder: 'border-indigo-400 bg-indigo-50/20', icon: '🔍', desc: 'Monitorar os resultados' },
                    { id: 'Concluído', title: 'Ação (Act)', color: 'border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-slate-900/40', badgeColor: 'bg-emerald-100 text-emerald-860', hoverBorder: 'border-emerald-400 bg-emerald-50/20', icon: '📌', desc: 'Padronizar e consolidar' }
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-1">
                          <span className="font-bold text-[9.5px] uppercase tracking-wider text-slate-700 dark:text-slate-200 flex items-center gap-1">
                        ...
                        <div className="space-y-1.5 flex-1 flex flex-col justify-start overflow-y-auto">
                          <AnimatePresence mode="popLayout">
                            {colPlans.map(p => (
                              <motion.div
                                ...
                                className="p-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-350 rounded shadow-xs hover:shadow-sm cursor-grab active:cursor-grabbing transition relative group select-none flex flex-col gap-1 text-left"
                              >
                                <strong className="text-slate-800 dark:text-slate-100 text-[10px] leading-tight block font-semibold">{p.title}</strong>
                                ...
                                <div className="flex items-center justify-between mt-1 pt-1 border-t border-slate-100 dark:border-slate-700">
                                  <button
                                    type="button"
                                    disabled={colIndex === 0}
                                    onClick={() => {
                                    ...
                                    className="p-0.5 rounded transition text-slate-400 hover:text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 dark:bg-slate-800/80 disabled:opacity-20 disabled:pointer-events-none cursor-pointer"
                          ...
                          {colPlans.length === 0 && (
                            <div className="py-4 flex-1 flex items-center justify-center border border-dashed border-slate-200 dark:border-slate-700 rounded-md">
                ...
                {/* Create Plan form */}
                <form onSubmit={handleCreateActionPlan} className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-700">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <input
                      ...
                      className="border border-slate-200 dark:border-slate-700 rounded p-1.5 bg-white dark:bg-slate-800 text-[11px] focus:outline-none focus:border-safety-green"
                    />
                    ...
                    <input
                      ...
                      className="border border-slate-200 dark:border-slate-700 rounded p-1.5 bg-white dark:bg-slate-800 text-[11px] focus:outline-none focus:border-safety-green font-mono"
                    />
                  </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-12 text-center text-slate-400 rounded border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center gap-1.5">
              <ShieldAlert className="w-8 h-8 text-slate-350 bg-slate-100 dark:bg-slate-800/80/40" />
              <span className="font-bold text-slate-600 dark:text-slate-300 uppercase text-[10px]">Selecione um Acidente/Desvio</span>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-800 w-full max-w-2xl rounded border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden animate-fade-in text-xs max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreateIncident} className="p-4 space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="font-bold block mb-1 text-[10px] text-slate-500 dark:text-slate-400 uppercase">Trabalhador Informante</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="font-bold block mb-1 text-[10px] text-slate-500 dark:text-slate-400 uppercase">Data do Fato</label>
                  <input
                    type="date"
                    required
                    value={newAcc.date}
                    onChange={(e) => setNewAcc({...newAcc, date: e.target.value})}
                    className="w-full border border-slate-200 dark:border-slate-700 rounded p-1.5 focus:outline-none focus:border-safety-green text-[11px] font-mono"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="font-bold block mb-1 text-[10px] text-slate-500 dark:text-slate-400 uppercase">Categoria do Evento</label>
                  <select
                    value={newAcc.type}
                ...
                <div>
                  <label className="font-bold block mb-1 text-[10px] text-slate-500 dark:text-slate-400 uppercase">Setor do Ocorrido</label>
                  <select
                    value={newAcc.sector}
                ...
                <div>
                  <label className="font-bold block mb-1 text-[10px] text-slate-500 dark:text-slate-400 uppercase">Gravidade Operacional</label>
                  <select
              ...
              <div>
                <label className="font-bold block mb-1 text-[10px] text-slate-500 dark:text-slate-400 uppercase">Descrição Textual do Ocorrido</label>
                <textarea
                  required
                  rows={2}
                  ...
                  className="w-full border border-slate-200 dark:border-slate-700 rounded p-2 focus:outline-none focus:border-safety-green text-[11px]"
                />
              </div>
              ...
              <div className="space-y-1.5 border-t border-slate-100 dark:border-slate-700 pt-2.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:grid-cols-3">
                  <div>
                    <label className="text-[8px] text-slate-500 dark:text-slate-400 font-bold uppercase block mb-0.5">Método</label>
                    <input
                      type="text"
                      ...
                      className="w-full border border-slate-200 dark:border-slate-700 rounded p-1 focus:border-safety-green focus:outline-none text-[10px]"
                    />
                  </div>
                  <div>
                    <label className="text-[8px] text-slate-500 dark:text-slate-400 font-bold uppercase block mb-0.5">Máquina</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-[8px] text-slate-500 dark:text-slate-400 font-bold uppercase block mb-0.5">Medida</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-[8px] text-slate-500 dark:text-slate-400 font-bold uppercase block mb-0.5">Meio Ambiente</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-[8px] text-slate-500 dark:text-slate-400 font-bold uppercase block mb-0.5">Mão de Obra</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-[8px] text-slate-500 dark:text-slate-400 font-bold uppercase block mb-0.5">Material</label>
                    <input
                      type="text"
              ...
              <div className="pt-3 border-t border-slate-150 flex justify-end gap-2 text-[10px]">
                <button
                  ...
                  className="px-3 py-1.5 hover:bg-slate-50 dark:hover:bg-slate-700/50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold rounded cursor-pointer uppercase"
                >
                  Cancelar
                </button>
                <button
